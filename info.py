...
DATABASE_NAME = environ.get('DATABASE_NAME', "Datta")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Modi')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "False")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by Modi</b>⚡\n\n🎦 <b>File Name: </b> ➥  <i>{file_caption}</i>\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n                ❤️<b>WE LOVE YOU</b>❤️\n🔥  ↭ <b>Join Now Modi(https://t.me/real_MoviesAdda2)</b> ↭  🔥")
...
DOWNLOAD_TEXT_URL = "https://t.me/Modi"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/Modi"
...
# Born to make history Modi !
# Thank you Modi for helping us in this Journey
# 🥰  Thank you for giving me credit Modi  🥰
# for any error please contact me -> telegramModi or insta Modi 
# rip paid developers 🤣 - >> No need to buy paid source code while Modi is here 😍😍